...
public class 表格 {
    ...
    public void test() throws IOException, InvalidFormatException {
        ...
        FileOutputStream out = new FileOutputStream(new File("f:/create_table.docx"));
        //添加标题
        ...
        //表格第五行
        XWPFTableRow infoTableRowSex = infoTable.createRow();
        infoTableRowSex.getCell(0).setText("图片");
        infoTableRowSex.getCell(1).setText(": 图片");
